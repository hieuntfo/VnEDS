      ...
      <div className="flex justify-between items-end mb-4">
        <div>
          ...
          <p className="text-gray-500 mt-2">
            Các thành tố cấu tạo nhỏ nhất không thể chia nhỏ hơn.
          </p>
        </div>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs font-sans">
            <thead className="text-gray-400 border-b border-gray-100">
              <tr>
                <th className="pb-3 font-mono font-bold uppercase tracking-wider text-[10px]">
                  Type
                </th>
                <th className="pb-3 font-mono font-bold uppercase tracking-wider text-[10px]">
            ...
            <tbody className="divide-y divide-gray-50 text-gray-600">
              <tr className="hover:bg-gray-50/50">
                ...
                <td className="py-3">
                  Chấm đỏ{" "}
                  <span className="font-mono text-[10px] bg-red-100 text-red-700 px-1 rounded">
                    #AE2727
                  </span>{" "}
                  + "Live" trước Title.
                </td>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="border-b border-gray-100">
              <tr>
                <th className="px-4 py-3 font-mono text-[10px] text-gray-400 uppercase tracking-widest w-20">
                  ID
                </th>
            ...
            <tbody className="divide-y divide-gray-50">
              {ATOMS.map((a) => (
                ...
                >
                  ...
                  <td className="px-4 py-4 font-mono text-[10px] text-[#9F224E]">
                    {a.slots}
                  </td>
                </tr>
              ))}
