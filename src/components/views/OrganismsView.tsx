  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      <div className="flex justify-between items-end mb-4">
        <div>
          <h1 className="text-4xl font-heading italic text-gray-900 leading-none">Organisms</h1>
          <p className="text-gray-500 mt-2">Các vùng (zone) hoặc block lớn để tạo thành 1 layout hoàn chỉnh.</p>
        </div>
      </div>
