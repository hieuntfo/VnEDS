...
└─ FOOTER ────────────────────────────────────┘`}
      ...
      <section className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm flex flex-col gap-6">
          <div className="flex justify-between items-center border-b border-gray-100 pb-4">
            <h3 className="font-bold uppercase tracking-widest text-xs text-gray-400">04 / Layout Templates: Template 1</h3>
          </div>
          
          <div className="flex flex-col gap-4">
            <div>
              <h4 className="font-bold text-gray-900 border-l-2 border-[#9F224E] pl-2 uppercase tracking-wide mb-2 text-sm">Template 1 (Cụm 7 tin Top)</h4>
              <p className="text-sm text-gray-600 mb-4">
                Layout chuyên dụng hiển thị nhiều tin bài, đặc biệt phù hợp cho các Landing Page sự kiện, tiêu điểm thời sự.
              </p>
            </div>
            
            <div className="bg-gray-50 border border-gray-100 rounded-xl p-5">
              <h5 className="text-[10px] uppercase font-bold text-gray-400 mb-3 tracking-widest">Đặc tả chi tiết (Specs)</h5>
              <ul className="text-xs text-gray-700 space-y-3 font-sans">
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    <strong className="text-gray-900 block mb-0.5">Cấu trúc Topstory (Cụm tin Top)</strong> 
                    Gồm tổng cộng <strong className="text-[#9F224E]">7 tin</strong>. Thường đi lồng ghép với 1 tin to (số 1), 2 tin nhỏ bên cạnh, và 4 tin dàn ngang bên dưới.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    <strong className="text-gray-900 block mb-0.5">Kích thước Thumbnail (Tin số 1)</strong> 
                    Sử dụng thumb kích thước lớn: <strong className="font-mono bg-white border border-gray-200 px-1 rounded">770x462</strong> pixel (Tỷ lệ 5:3).
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    <strong className="text-gray-900 block mb-0.5">Quy định Quảng cáo</strong> 
                    Tại Template 1 này, <strong className="text-red-600">Tuyệt đối không khai thác banner quảng cáo Large 1</strong> trên mảng khối cụm tin top. (Thay vào đó có thể sử dụng banner Breakpage như 970x250 hiển thị ngay bên dưới cụm này).
                  </p>
                </li>
              </ul>
            </div>
...
└───────────────────────────────────────────────┘`}
          ...
          <div className="flex flex-col gap-4 pt-8 border-t border-gray-100 mt-2">
            <div>
              <h4 className="font-bold text-gray-900 border-l-2 border-[#9F224E] pl-2 uppercase tracking-wide mb-2 text-sm">Template 2 (Cụm 8 tin Top + Large 1)</h4>
              <p className="text-sm text-gray-600 mb-4">
                Layout chia cột có khoảng không gian bên phải để khai thác thêm vùng quảng cáo Large 1 (Dành cho trang thư mục loại 2 hoặc chuyên trang).
              </p>
            </div>
            ...
            <div className="bg-gray-50 border border-gray-100 rounded-xl p-5">
              ...
              <ul className="text-xs text-gray-700 space-y-3 font-sans">
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    <strong className="text-gray-900 block mb-0.5">Cấu trúc Topstory (Cụm tin Top)</strong> 
                    Gồm tổng cộng <strong className="text-[#9F224E]">8 tin</strong>. Bao gồm 1 tin kích thước to (số 1), 2 tin nhỏ ở cột giữa, và 5 tin ngang nằm bên dưới bài to.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-5 h-5 rounded-full bg-[#FFE7E9] text-[#9F224E] flex items-center justify-center font-bold text-[10px] shrink-0 mt-0.5">2</span>
                  <p>
                    <strong className="text-gray-900 block mb-0.5">Kích thước Thumbnail (Tin số 1)</strong> 
                    Sử dụng thumb kích thước vừa: <strong className="font-mono bg-white border border-gray-200 px-1 rounded">536x322</strong> pixel.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-5 h-5 rounded-full bg-[#FFE7E9] text-[#9F224E] flex items-center justify-center font-bold text-[10px] shrink-0 mt-0.5">3</span>
                  <p>
                    <strong className="text-gray-900 block mb-0.5">Quy định Quảng cáo (Ads Large 1)</strong> 
                    Tại Template 2, <strong className="text-[#1DB549]">Có khai thác quảng cáo Large 1 (300x600)</strong> bố trí cố định ở cột phải, chạy dọc theo toàn bộ cụm tin top.
                  </p>
                </li>
              </ul>
            </div>
